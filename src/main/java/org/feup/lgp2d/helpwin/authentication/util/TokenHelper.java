package org.feup.lgp2d.helpwin.authentication.util;
...
public class TokenHelper {
     ...
     * @param expires Date
     */
    public static String getJWTString(Date expires, String email) {
        if (expires == null || email == null) {
